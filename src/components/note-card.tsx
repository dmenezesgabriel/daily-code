...
export default function NoteCard({ note }: NoteCardProps) {
  return (
    <div className="cartoon-border subtle-card-texture relative h-full overflow-hidden rounded-lg bg-white shadow-md transition-all duration-300 ease-in-out hover:-translate-y-2 hover:scale-105 hover:shadow-xl">
